...
function CNetworkManager() {
    ...
    this._onLoginFailed = function() {
        ...
        g_oCTLMultiplayer.showOfflineDialog("NO CONNECTION<br/>(Connect to find someone to play online)", "on_ctl_multiplayer_play_offline");
    };
    ...
    */
    ...
    this.gotoMatchMakingRoom = function() {
        ...
        //Join the room
        _oCurClient.multiplayer.createJoinRoom('matchmakingroom1', ROOM_TYPE_MATCHMAKING, true, null, {
            nickname: _szNickname
        }, function(connection) {
            _oCurConnection = connection;
            connection.addMessageCallback("*", _oMessageForwarder.messageHandler);
