...
PlayerIO = {
    ...
    authenticate: function(gameId, connectionId, authenticationArguments, playerInsightSegments, successCallback, errorCallback) {
        if (authenticationArguments.publishingnetworklogin == 'auto') {
            ...
            PublishingNetwork.dialog("login", {
                gameId: gameId,
                ...
                if (r.error) {
                    ...
                    }, playerInsightSegments, successCallback, errorCallback)
                }
            })
            return
        }
...
(function() {
    ...
    c.connect = function(gameId, connectionId, userId, auth, partnerId, playerInsightSegments, clientAPI, clientInfo, successCallback, errorCallback, converter) {
        this.call(10, {
            gameid: gameId,
            connectionid: connectionId,
            userid: userId,
        ...
        }, successCallback, errorCallback, converter)
    }
    ...
    c.authenticate = function(gameId, connectionId, authenticationArguments, playerInsightSegments, clientAPI, clientInfo, playCodes, successCallback, errorCallback, converter) {
        this.call(13, {
            gameid: gameId,
            connectionid: connectionId,
    ...
    c.createRoom = function(roomId, roomType, visible, roomData, isDevRoom, successCallback, errorCallback, converter) {
        this.call(21, {
            roomid: roomId,
            roomtype: roomType,
            visible: visible,
    ...
    c.joinRoom = function(roomId, joinData, isDevRoom, successCallback, errorCallback, converter) {
        this.call(24, {
            roomid: roomId,
            joindata: joinData,
            isdevroom: isDevRoom
    ...
    c.createJoinRoom = function(roomId, roomType, visible, roomData, joinData, isDevRoom, successCallback, errorCallback, converter) {
        this.call(27, {
            roomid: roomId,
            roomtype: roomType,
            visible: visible,
    ...
    c.listRooms = function(roomType, searchCriteria, resultLimit, resultOffset, onlyDevRooms, successCallback, errorCallback, converter) {
        this.call(30, {
            roomtype: roomType,
    ...
    c.userLeftRoom = function(extendedRoomId, newPlayerCount, closed, successCallback, errorCallback, converter) {
        this.call(40, {
    ...
    c.writeError = function(source, error, details, stacktrace, extraData, successCallback, errorCallback, converter) {
        this.call(50, {
            source: source,
            error: error,
            details: details,
    ...
    c.updateRoom = function(extendedRoomId, visible, roomData, successCallback, errorCallback, converter) {
        this.call(53, {
            extendedroomid: extendedRoomId,
            visible: visible,
            roomdata: roomData
    ...
    c.createObjects = function(objects, loadExisting, successCallback, errorCallback, converter) {
        this.call(82, {
            objects: objects,
            loadexisting: loadExisting
        }, successCallback, errorCallback, converter)
    }
    c.loadObjects = function(objectIds, successCallback, errorCallback, converter) {
        this.call(85, {
            objectids: objectIds
        }, successCallback, errorCallback, converter)
    }
    ...
    c.saveObjectChanges = function(lockType, changesets, createIfMissing, successCallback, errorCallback, converter) {
        this.call(88, {
            locktype: lockType,
    ...
    c.deleteObjects = function(objectIds, successCallback, errorCallback, converter) {
        this.call(91, {
            objectids: objectIds
        }, successCallback, errorCallback, converter)
    }
    c.loadMatchingObjects = function(table, index, indexValue, limit, successCallback, errorCallback, converter) {
        this.call(94, {
            table: table,
            index: index,
    ...
    c.loadIndexRange = function(table, index, startIndexValue, stopIndexValue, limit, successCallback, errorCallback, converter) {
        this.call(97, {
            table: table,
            index: index,
    ...
    c.deleteIndexRange = function(table, index, startIndexValue, stopIndexValue, successCallback, errorCallback, converter) {
        this.call(100, {
            table: table,
            index: index,
            startindexvalue: startIndexValue,
    ...
    c.loadMyPlayerObject = function(successCallback, errorCallback, converter) {
        this.call(103, {}, successCallback, errorCallback, converter)
    }
    c.payVaultReadHistory = function(page, pageSize, targetUserId, successCallback, errorCallback, converter) {
        this.call(160, {
            page: page,
            pagesize: pageSize,
    ...
    c.payVaultRefresh = function(lastVersion, targetUserId, successCallback, errorCallback, converter) {
        this.call(163, {
            lastversion: lastVersion,
            targetuserid: targetUserId
        }, successCallback, errorCallback, converter)
    }
    c.payVaultConsume = function(ids, targetUserId, successCallback, errorCallback, converter) {
        this.call(166, {
            ids: ids,
            targetuserid: targetUserId
        }, successCallback, errorCallback, converter)
    }
    c.payVaultCredit = function(amount, reason, targetUserId, successCallback, errorCallback, converter) {
        this.call(169, {
            amount: amount,
            reason: reason,
            targetuserid: targetUserId
    ...
    c.payVaultDebit = function(amount, reason, targetUserId, successCallback, errorCallback, converter) {
        this.call(172, {
            amount: amount,
            reason: reason,
            targetuserid: targetUserId
    ...
    c.payVaultBuy = function(items, storeItems, targetUserId, successCallback, errorCallback, converter) {
        this.call(175, {
            items: items,
    ...
    c.payVaultGive = function(items, targetUserId, successCallback, errorCallback, converter) {
        this.call(178, {
            items: items,
            targetuserid: targetUserId
        }, successCallback, errorCallback, converter)
    }
    c.payVaultPaymentInfo = function(provider, purchaseArguments, items, successCallback, errorCallback, converter) {
        this.call(181, {
            provider: provider,
    ...
    c.payVaultUsePaymentInfo = function(provider, providerArguments, successCallback, errorCallback, converter) {
        this.call(184, {
            provider: provider,
            providerarguments: providerArguments
        }, successCallback, errorCallback, converter)
    }
    c.partnerPayTrigger = function(key, count, successCallback, errorCallback, converter) {
        this.call(200, {
            key: key,
            count: count
        }, successCallback, errorCallback, converter)
    }
    c.partnerPaySetTag = function(partnerId, successCallback, errorCallback, converter) {
        this.call(203, {
            partnerid: partnerId
        }, successCallback, errorCallback, converter)
    }
    c.notificationsRefresh = function(lastVersion, successCallback, errorCallback, converter) {
        this.call(213, {
            lastversion: lastVersion
        }, successCallback, errorCallback, converter)
    }
    c.notificationsRegisterEndpoints = function(lastVersion, endpoints, successCallback, errorCallback, converter) {
        this.call(216, {
            lastversion: lastVersion,
            endpoints: endpoints
        }, successCallback, errorCallback, converter)
    }
    c.notificationsSend = function(notifications, successCallback, errorCallback, converter) {
        this.call(219, {
            notifications: notifications
        }, successCallback, errorCallback, converter)
    }
    c.notificationsToggleEndpoints = function(lastVersion, endpoints, enabled, successCallback, errorCallback, converter) {
        this.call(222, {
            lastversion: lastVersion,
            endpoints: endpoints,
            enabled: enabled
    ...
    c.notificationsDeleteEndpoints = function(lastVersion, endpoints, successCallback, errorCallback, converter) {
        this.call(225, {
            lastversion: lastVersion,
            endpoints: endpoints
        }, successCallback, errorCallback, converter)
    }
    c.gameRequestsSend = function(requestType, requestData, requestRecipients, successCallback, errorCallback, converter) {
        this.call(241, {
    ...
    c.gameRequestsRefresh = function(playCodes, successCallback, errorCallback, converter) {
        this.call(244, {
            playcodes: playCodes
        }, successCallback, errorCallback, converter)
    }
    c.gameRequestsDelete = function(requestIds, successCallback, errorCallback, converter) {
        this.call(247, {
            requestids: requestIds
        }, successCallback, errorCallback, converter)
    }
    c.achievementsRefresh = function(lastVersion, successCallback, errorCallback, converter) {
        this.call(271, {
            lastversion: lastVersion
        }, successCallback, errorCallback, converter)
    }
    c.achievementsLoad = function(userIds, successCallback, errorCallback, converter) {
        this.call(274, {
            userids: userIds
        }, successCallback, errorCallback, converter)
    }
    c.achievementsProgressSet = function(achievementId, progress, successCallback, errorCallback, converter) {
        this.call(277, {
            achievementid: achievementId,
            progress: progress
        }, successCallback, errorCallback, converter)
    }
    c.achievementsProgressAdd = function(achievementId, progressDelta, successCallback, errorCallback, converter) {
        this.call(280, {
            achievementid: achievementId,
            progressdelta: progressDelta
        }, successCallback, errorCallback, converter)
    }
    c.achievementsProgressMax = function(achievementId, progress, successCallback, errorCallback, converter) {
        this.call(283, {
            achievementid: achievementId,
            progress: progress
        }, successCallback, errorCallback, converter)
    }
    c.achievementsProgressComplete = function(achievementId, successCallback, errorCallback, converter) {
        this.call(286, {
            achievementid: achievementId
        }, successCallback, errorCallback, converter)
    }
    c.playerInsightRefresh = function(successCallback, errorCallback, converter) {
        this.call(301, {}, successCallback, errorCallback, converter)
    }
    c.playerInsightSetSegments = function(segments, successCallback, errorCallback, converter) {
        this.call(304, {
            segments: segments
        }, successCallback, errorCallback, converter)
    }
    c.playerInsightTrackInvitedBy = function(invitingUserId, invitationChannel, successCallback, errorCallback, converter) {
        this.call(307, {
            invitinguserid: invitingUserId,
            invitationchannel: invitationChannel
        }, successCallback, errorCallback, converter)
    }
    c.playerInsightTrackEvents = function(events, successCallback, errorCallback, converter) {
        this.call(311, {
            events: events
        }, successCallback, errorCallback, converter)
    }
    c.playerInsightTrackExternalPayment = function(currency, amount, successCallback, errorCallback, converter) {
        this.call(314, {
            currency: currency,
            amount: amount
        }, successCallback, errorCallback, converter)
    }
    c.playerInsightSessionKeepAlive = function(successCallback, errorCallback, converter) {
        this.call(317, {}, successCallback, errorCallback, converter)
    }
    c.playerInsightSessionStop = function(successCallback, errorCallback, converter) {
        this.call(320, {}, successCallback, errorCallback, converter)
    }
    c.oneScoreLoad = function(userIds, successCallback, errorCallback, converter) {
        this.call(351, {
            userids: userIds
        }, successCallback, errorCallback, converter)
    }
    c.oneScoreSet = function(score, successCallback, errorCallback, converter) {
        this.call(354, {
            score: score
        }, successCallback, errorCallback, converter)
    }
    c.oneScoreAdd = function(score, successCallback, errorCallback, converter) {
        this.call(357, {
            score: score
        }, successCallback, errorCallback, converter)
    }
    c.oneScoreRefresh = function(successCallback, errorCallback, converter) {
        this.call(360, {}, successCallback, errorCallback, converter)
    }
    c.simpleConnect = function(gameId, usernameOrEmail, password, playerInsightSegments, clientAPI, clientInfo, successCallback, errorCallback, converter) {
        this.call(400, {
            gameid: gameId,
    ...
    c.simpleRegister = function(gameId, username, password, email, captchaKey, captchaValue, extraData, partnerId, playerInsightSegments, clientAPI, clientInfo, successCallback, errorCallback, converter) {
        this.call(403, {
            gameid: gameId,
            username: username,
            password: password,
    ...
    c.simpleRecoverPassword = function(gameId, usernameOrEmail, successCallback, errorCallback, converter) {
        this.call(406, {
            gameid: gameId,
            usernameoremail: usernameOrEmail
        }, successCallback, errorCallback, converter)
    }
    c.kongregateConnect = function(gameId, userId, gameAuthToken, playerInsightSegments, clientAPI, clientInfo, successCallback, errorCallback, converter) {
        this.call(412, {
            gameid: gameId,
            userid: userId,
    ...
    c.simpleGetCaptcha = function(gameId, width, height, successCallback, errorCallback, converter) {
        this.call(415, {
            gameid: gameId,
            width: width,
            height: height
    ...
    c.facebookOAuthConnect = function(gameId, accessToken, partnerId, playerInsightSegments, clientAPI, clientInfo, successCallback, errorCallback, converter) {
        this.call(418, {
            gameid: gameId,
    ...
    c.steamConnect = function(gameId, steamAppId, steamSessionTicket, playerInsightSegments, clientAPI, clientInfo, successCallback, errorCallback, converter) {
        this.call(421, {
            gameid: gameId,
    ...
    c.simpleUserGetSecureLoginInfo = function(successCallback, errorCallback, converter) {
        this.call(424, {}, successCallback, errorCallback, converter)
    }
    c.joinCluster = function(clusterAccessKey, isDevelopmentServer, ports, machineName, version, machineId, os, cpu, cpuCores, cpuLogicalCores, cpuAddressWidth, cpuMaxClockSpeed, ramMegabytes, ramSpeed, successCallback, errorCallback, converter) {
        this.call(504, {
    ...
    c.getGameAssemblyUrl = function(clusterAccessKey, gameCodeId, machineId, successCallback, errorCallback, converter) {
        this.call(513, {
            clusteraccesskey: clusterAccessKey,
    ...
    c.devServerLogin = function(username, password, successCallback, errorCallback, converter) {
        this.call(524, {
            username: username,
            password: password
        }, successCallback, errorCallback, converter)
    }
    c.webserviceOnlineTest = function(successCallback, errorCallback, converter) {
        this.call(533, {}, successCallback, errorCallback, converter)
    }
    c.getServerInfo = function(machineId, successCallback, errorCallback, converter) {
        this.call(540, {
            machineid: machineId
        }, successCallback, errorCallback, converter)
    }
    c.socialRefresh = function(successCallback, errorCallback, converter) {
        this.call(601, {}, successCallback, errorCallback, converter)
    }
    c.socialLoadProfiles = function(userIds, successCallback, errorCallback, converter) {
        this.call(604, {
            userids: userIds
        }, successCallback, errorCallback, converter)
    }
...
(function() {
    ...
    _pio.bigDB = function(channel) {
        ...
        this.createObject = function(table, key, obj, successCallback, errorCallback) {
            ...
            channel.createObjects([{
                key: key,
                table: table,
                properties: properties
            }], false, successCallback, errorCallback, function(results) {
        ...
        this.load = function(table, key, successCallback, errorCallback) {
            channel.loadObjects([{
                table: table,
                keys: [key]
            }], successCallback, errorCallback, function(results) {
                if (results.objects.length == 1) {
        ...
        this.loadOrCreate = function(table, key, successCallback, errorCallback) {
            channel.createObjects([{
                ...
                table: table,
                properties: []
            }], true, successCallback, errorCallback, function(results) {
                if (results.objects.length == 1) {
        ...
        this.deleteKeys = function(table, keys, successCallback, errorCallback) {
            channel.deleteObjects([{
                table: table,
                keys: keys
            }], successCallback, errorCallback, function(result) {
                return null
            })
        }
        /**
        ...
        this._internal_ = function(method, arg1) {
            switch (method) {
                ...
                case 'change-dbCurrent':
                    _pio.bigDBDeserialize(arg1, dbCurrent, true);
            }
        }
    ...
    _pio.compareForChanges = function(original, current, isObject, isRoot) {
                            ...
                            if (valueIsArray && value.bytearray) {
                                ...
                                if (valueIsArray) {
                                    prop.value = {
                                        ...
                                        arrayproperties: subChanges
                                    }
                                } else {
                                    prop.value = {
                                        valuetype: _pio.ValueType.Obj,
                                        objectproperties: subChanges
                                    }
                                }
                            }
                            changes.push(prop)
        ...
        for (var key in original) {
            if (current[key] == null || typeof(current[key]) == 'undefined') {
                ...
                changes.push(isObject ? {
                    name: key
                } : {
                    index: parseInt(key)
                }); //getProp(null, key, isObject));
            }
        }
...
(function() {
    ...
    _pio.multiplayer = function(channel) {
        ...
        this.joinRoom = function(roomId, joinData, successCallback, errorCallback) {
            ...
            clearTimeout(setTimeout(function() {
                successCallback(new _pio.connection())
            }, 10000))
            var originalStack = new Error();
    ...
    _pio.connection = function(originalStack, developmentServer, useSecureConnections, endpoints, joinKey, joinData, successCallback, errorCallback) {
        ...
        if (supportsBinaryWebsockets) {
            connect(function(useSecureConnections, endpoint, connectTimeout, onConnect, onDisconnect, onMesssage) {
                return new _pio.websocketConnection(true, useSecureConnections, endpoint, connectTimeout, onConnect, onDisconnect, onMesssage);
            })
        } else {
            _pio.isFlashFallbackEnabled(function(enabled) {
                if (enabled) {
                    connect(function(useSecureConnections, endpoint, connectTimeout, onConnect, onDisconnect, onMesssage) {
                        return new _pio.flashSocketConnection(endpoint, connectTimeout, onConnect, onDisconnect, onMesssage);
                    })
                } else {
                    connect(function(useSecureConnections, endpoint, connectTimeout, onConnect, onDisconnect, onMesssage) {
                        return new _pio.websocketConnection(false, useSecureConnections, endpoint, connectTimeout, onConnect, onDisconnect, onMesssage);
                    })
                }
            })
        }
            ...
            while (position < end) {
                ...
                switch (pattern) {
                    ...
                    case byteArrayTopPattern:
                        ...
                        break;
                    case unsignedIntegerBottomPattern:
                        output.addUInt(_pio.binaryserializer.uintFromBytes(bytes, position, length));
                        break;
                    case shortLongBottomPattern:
                    case longBottomPattern:
                        output.addLong(_pio.binaryserializer.longFromBytes(bytes, position, length));
                        break;
                    case shortUnsignedLongBottomPattern:
                    case unsignedLongBottomPattern:
                        output.addULong(_pio.binaryserializer.ulongFromBytes(bytes, position, length));
                        break;
                    case doublePattern:
                        output.addDouble(_pio.binaryserializer.doubleFromBytes(bytes, position, length));
                        break;
                    case floatPattern:
                        output.addFloat(_pio.binaryserializer.floatFromBytes(bytes, position, length));
                        break;
                    case booleanTruePattern:
...
(function() {
    ...
    _pio.playerInsight = function(channel) {
        ...
        this.trackEvent = function(eventType, value, successCallback, errorCallback) {
            channel.playerInsightTrackEvents([{
                eventtype: eventType,
                value: value
            }], successCallback, errorCallback, function(result) {});
        }
    ...
    _pio.oneScore = function(channel) {
        ...
        this.load = function(userIds, successCallback, errorCallback) {
            ...
            channel.oneScoreLoad(userIds, successCallback, errorCallback, function(result) {
                if (result == null || result.onescores == null || result.onescores.length == 0) {
                    return [];
                }
                var scores = [];
                var j = 0;
    ...
    _pio.notifications = function(channel) {
        ...
        this.registerEndpoint = function(endpointType, identifier, configuration, enabled, successCallback, errorCallback) {
            ...
            if (current == null || current.enabled != enabled || !equalConfiguration(current.configuration, configuration)) {
                channel.notificationsRegisterEndpoints(version, [{
                    type: endpointType,
                    identifier: identifier,
                    configuration: _pio.convertToKVArray(configuration),
                    enabled: enabled
                }], successCallback, errorCallback, refreshed)
...
(function() {
    ...
    _pio.publishingNetworkProfiles = function(channel) {
        ...
        this.showProfile = function(userId, closedCallback) {
            _pio.showDialog('profile', channel, {
                userId: userId
            }, closedCallback)
        }
...
(function() {
    ...
    _pio.publishingNetworkRelations = function(channel, connectUserId, publishingNetwork) {
        ...
        this.showRequestFriendshipDialog = function(userId, closedCallback) {
            _pio.showDialog('requestfriendship', channel, {
                userId: userId
            }, closedCallback)
        }
        ...
        this.showRequestBlockUserDialog = function(userId, closedCallback) {
            _pio.showDialog('requestblockuser', channel, {
                userId: userId
            }, function() {
