...
CGameStrikerBase.prototype._init = function(oParentContainer, iCurLevel) {
    ...
    this._pGoalSize = {
        w: oSprite.width - iSidePostWidth,
        h: oSprite.height - iTopPostHeight / 2
    };
    ...
    createjs.Tween.get(this._oFade).to({
        alpha: 0
...
CGameStrikerBase.prototype.addImpulseToBall = function(oDir) {
    ...
    this._oScene.setElementAngularVelocity(oBall, {
        x: 0,
        y: 0,
        z: 0
    });
    ...
    var oParent = this;
    setTimeout(function() {
        oParent.chooseDirectionGoalKeeper();
    }, 100);
...
CGameStrikerBase.prototype.resetBallPosition = function() {
    ...
    this._oScene.setElementVelocity(oBallBody, {
        x: 0,
        y: 0,
        z: 0
    });
    this._oScene.setElementAngularVelocity(oBallBody, {
        x: 0,
        y: 0,
        z: 0
    });
...
CGameStrikerBase.prototype.displayShock = function(iTime, iXIntensity, iYIntensity) {
    ...
    createjs.Tween.get(oParent._oContainerGame).to({
